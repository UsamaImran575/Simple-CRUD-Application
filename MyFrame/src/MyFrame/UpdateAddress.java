...
class UpdateAddress extends JFrame implements ActionListener {
    ...
    public UpdateAddress()
    {
        ...
        title = new JLabel("Address Form");
        title.setFont(new Font("Arial", Font.PLAIN, 30));
        title.setSize(300, 30);
        title.setLocation(300, 30);
        c.add(title);
  
        name = new JLabel("Address");
      ...
      public static void UpdateAddress() throws ClassNotFoundException{
            ...
            int r=0;
             try
                {   
                        ...
                        String sql = "update AddressBook set addres = ? where CNIC = ?";
