...
class UpdatePhone extends JFrame implements ActionListener {
    ...
    public UpdatePhone()
    {
      ...
      public static void UpdatePhone() throws ClassNotFoundException{
            ...
            int r=0;
             try
                {   
                        ...
                        String sql = "update AddressBook set phone = ? where CNIC = ?";
